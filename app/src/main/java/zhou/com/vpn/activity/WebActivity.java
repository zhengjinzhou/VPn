...
import zhou.com.vpn.bean.LookDocBean;
import zhou.com.vpn.bean.NumBean;
import zhou.com.vpn.bean.SelectBean;
import zhou.com.vpn.bean.ShareBean;
import zhou.com.vpn.bean.TypeBean;
...
import zhou.com.vpn.presenter.WebPresenter;
import zhou.com.vpn.service.MyServpce;
import zhou.com.vpn.utils.AppManager;
import zhou.com.vpn.utils.DateUtil;
import zhou.com.vpn.utils.DownloadUtil;
import zhou.com.vpn.utils.JsonConvert;
import zhou.com.vpn.utils.LastPoint;
import zhou.com.vpn.utils.LoadDialog;
import zhou.com.vpn.utils.Md5Util;
import zhou.com.vpn.utils.ShareUtil;
import zhou.com.vpn.utils.SpUtil;
import zhou.com.vpn.utils.ToastUtil;
import zhou.com.vpn.utils.WebServiceUtil;
import zhou.com.vpn.utils.WpsUtil;
                            ...
                            public void callBack(SoapObject result) {
                                ...
                                WebServiceUtil.callWebService(Constant.BASE_URL + "/DMS_Phone/WebServices/WebServiceForFWNG.asmx", "GetWPSKeySN", ddd, new WebServiceUtil.WebServiceCallBack() {
                                    ...
                                    public void callBack(SoapObject result) {
                                        ...
                                        iappoffice.init();
                                        iappoffice.setFileProviderAuthor("com.agewnet.tx.fileProvider");
